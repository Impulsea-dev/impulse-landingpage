...
<div  >
  ...
  <p class="flex-grow-0 flex-shrink-0 md:text-base text-sm font-medium text-left text-white/70">
    Custom web solutions, billing systems, API development, and CRM integrations for telecommunications. Tailored to your unique needs, scalable solutions that drive growth and enhance customer satisfaction
  </p>
</div>

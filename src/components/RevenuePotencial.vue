<template>
    <section class="l-section relative" data-header-color="black" data-header-bg="white">
        <div class="mx-5 md:mx-20">
            <div class="flex flex-col lg:flex-row justify-between pt-20 md:pt-40 gap-4 relative">
            ...
            <div class="flex gap-2 pb-20 mt-4">
            ...
            <img src="../assets/images/rectangle.svg" class="hidden md:block absolute -top-20 left-0 -z-10" alt="">
        </div>

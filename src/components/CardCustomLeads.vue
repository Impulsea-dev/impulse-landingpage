<template>
    <div>
        <Card :className="'dark:!bg-[#32cd32] overflow-hidden relative z-10'">
            ...
            <svg width="80" height="197" viewBox="0 0 80 197" fill="none" xmlns="http://www.w3.org/2000/svg"
                class="w-80 h-56 ml-auto relative -right-12 place-self-end -bottom-20 -z-10" preserveAspectRatio="xMidYMid meet">
                <path

<template>
    <section class="l-section">
        <div class="flex justify-center px-40 py-60">
            <article class="bg-[#F6F6F6] flex rounded-xl shadow-2xl">
                <img src="../assets/images/action.svg" class="w-1/2" alt="">
                <div class="flex flex-col py-4 px-10">
                    <span class="text-5xl font-bold text-[#000] mt-20 w-2/3">Ready to see Impulse in Action?</span>

                    <form @submit.prevent="" class="mt-10">
                        <input type="text" id="scales" name="scales" placeholder="Your Email"
                            class="rounded-xl p-2 text-lg border text-[#858C94] border-[#8791A1] w-[420px]">
                        <div class="flex gap-x-1 mt-6">
                            <input type="checkbox"/>
                            <label for="scales" class="w-2/3 text-[#000000]">I agree to the <router-link to=""
                                    class="text-[#0079D8] hover:underline">privacy policy</router-link> including to
                                Impulse using my contact
                                details to contact me for marketing purposes.</label>
                        </div>
                        <div class="mt-10">

<template>
  <div>
        ...
        <div class="flex flex-col justify-start items-start absolute left-16 top-[148px] gap-8">
          ...
          <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-4">
            <p class="flex-grow-0 flex-shrink-0 w-[666px] font-semibold text-left text-white">
              <span class="flex-grow-0 flex-shrink-0 w-[666px] text-[32px] font-semibold text-left text-white">Impulse is
                a reliable ally to prominent technology companies and telecommunications
                firms.</span><span
          ...
          <div class="flex justify-center items-center flex-grow-0 flex-shrink-0 gap-4">
            ...
            <Button icon="material-symbols:chevron-right"
              ...
              @click="btnLink('contactus')" text="Contact Us" iconPosition="right" />
    ...
    <ModalNewsletter class="hidden md:block"/>
  </div>
</template>
<script>

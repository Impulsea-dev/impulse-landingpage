<template>
  <div class="">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 mt-3 ">
          <div class="flex flex-col col-span-1">
            ...
            <form class="space-y-8 mt-10" @submit.prevent="onSubmit" ref="form">
              <Textinput label="Your Name" name="from_name" type="text" placeholder="Your Name" v-model="name"
                :error="nameError" />
              <Textinput label="Email" name="reply_to" type="email" placeholder="Type your email" v-model="email"
                :error="emailError" />
              <!-- <Textinput
   ...
   /> -->
              ...
              <Textarea label="Message" name="message" placeholder="Your message" v-model="text" :error="textError" />
              <Button text="Sent" btnClass="btn-primary block-btn"
              ...
              <div class="flex-col    gap-4 relative">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0  gap-2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path d="M2.66699 11.9999V14.6666H13.3337V1.33325H2.66699V3.99992" stroke="white"
              ...
              <div class="flex-col  w-48   gap-1 relative">
                <div class="flex justify-start items-center flex-grow-0 flex-shrink-0  gap-2">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path d="M1.33301 3L7.99967 8L14.6663 3" stroke="white" stroke-linecap="round"
      ...
      <div class="flex-col  w-48   gap-1 relative">
        <div class="flex justify-start items-center flex-grow-0 flex-shrink-0  gap-2">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <path d="M0 0H16V16H0V0Z" fill="white" fill-opacity="0.01"></path>
            <path d="M1.33301 13H14.6663V8V3H7.99967H1.33301V8V13Z" stroke="white" stroke-linejoin="round"></path>
            <path d="M1.33301 3L7.99967 8L14.6663 3" stroke="white" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M7.99967 3H1.33301V8" stroke="white" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M14.6667 8V3H8" stroke="white" stroke-linecap="round" stroke-linejoin="round"></path>
          </svg>
          <p class="flex-grow-0 flex-shrink-0 text-base font-bold text-left text-white">Email</p>

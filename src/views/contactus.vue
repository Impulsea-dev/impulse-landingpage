    ...
    <img class="w-[636px] h-auto rounded-2xl" :src="contact" />
       ...
       <div class="flex flex-col lg:hidden space-y-4   justify-center items-center w-44   mt-6 relative ml-auto mr-auto ">
            ...
            <div class="flex-col   w-44   gap-1 relative ">
              ...
              <p class="text-base font-medium text-center text-white/70">
                Company address 2340
              </p>
            </div>
            <div class="flex-col  w-44   gap-1 relative">
              <div class="flex justify-center items-center   gap-2">
                ...
                <p class="text-base font-bold text-left text-white">Phone number</p>
              </div>
              <p class="flex flex-col justify-center text-base font-medium text-center text-white/70">
                +491234002
              </p>
            </div>
            <div

<template>
  ...
  <p
    class="w-[1276px] absolute left-[123px] top-[904px] text-base font-medium text-left text-white"
  >
    <span class="w-[1276px] text-base font-medium text-left text-white"
      >Lorem ipsum dolor sit amet consectetur. Luctus arcu maecenas massa facilisis commodo ipsum.
      At ipsum elit eros a egestas amet. Ut nibh volutpat habitasse lorem egestas est. Nunc
      consequat suspendisse libero gravida auctor eget nec adipiscing ac. Proin sollicitudin
      ultricies ut risus pellentesque tellus nunc sapien diam. Mattis massa quis lectus ipsum ac
      lorem morbi.</span
    ><br />
  </p>
  <div
    class="flex justify-center items-center absolute left-[120px] top-[632px] gap-2 px-8 py-3 rounded-[32px] bg-[#e2e8ea]"
  >
    <svg
      width="16"
      height="10"
  ...
  <div class="flex flex-col justify-start items-start absolute left-[120px] top-[1048px] gap-8">
    <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-4">
      <p class="flex-grow-0 flex-shrink-0 w-[422px] text-[32px] font-bold text-left text-white">
        Software Development
      </p>
      <p class="flex-grow-0 flex-shrink-0 w-[1272px] text-base font-medium text-left text-white/70">
        <span
  ...
  <div class="flex flex-col justify-start items-start absolute left-[120px] top-[2120px] gap-8">
    <div class="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-4">
      <p class="flex-grow-0 flex-shrink-0 w-[422px] text-[32px] font-bold text-left text-white">
        Software Development
      </p>

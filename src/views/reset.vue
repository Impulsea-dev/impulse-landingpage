        ...
        <div class="relative py-3 sm:max-w-xl sm:mx-auto">
          ...
          <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            <div class="max-w-md mx-auto">
              ...
              <div>
                <h1 class="flex text-2xl font-semibold items-center justify-center">Reset Password</h1>
              </div>            
              <div class="divide-y divide-gray-200">
                <div class="py-8 text-base leading-6 space-y-10 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div class="relative text-sm">
                    We will send you instructions to your registered email.
                  </div>
                  <div class="relative">
                    <TextInput autocomplete="off" id="email" name="email" type="email" v-model="email" :error="emailError" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Email" />
                  </div>
                  <div class="relative">
                    <button class="btn-btnp text-white rounded-md px-2 py-1 w-full " type="submit">Send</button>
                  </div>
                </div>
              </div>
            </div>

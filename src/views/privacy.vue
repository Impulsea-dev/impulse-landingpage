  ...
  <div>
    ...
    <div class="p-6 rounded-lg shadow-lg" v-else>
      ...
      <p class="text-sm">Impulse está plenamente comprometida a garantizar la correcta gestión y uso de todos los datos
        ...
        la Extensión del Reino Unido al Marco de Privacidad de Datos UE-EE. UU.</p>
      ...
      <ul class="list-decimal ml-8">
        <li>Los tipos de datos personales que Impulse recopila y conserva</li>
        <li>Cómo Impulse recopila datos personales y los fines para los que recopila, conserva y utiliza datos
          personales; </li>
        <li>A quién Impulse divulga datos personales;</li>
        <li>Cómo un individuo puede acceder a sus datos personales que son retenidos por Impulse y solicitar la
          corrección de dicha información;</li>
        <li>Cómo un individuo puede presentar una queja sobre un problema de privacidad o una presunta violación de la
      ...
      <p class="text-sm mt-2">A veces, como parte de un servicio prestado a un cliente, Impulse también puede recopilar
        ...
        pueden incluir, nombre, dirección de facturación, información de contacto y cuenta y datos de medición. Un
        ejemplo de esto sería cuando Impulse proporciona alojamiento o soluciones administradas en nombre de un cliente
        o cuando proporcionamos soporte o servicios de mantenimiento para nuestros clientes, y no es razonablemente
        práctico utilizar materiales anonimizados. Estos datos personales se retienen únicamente de acuerdo con los
        requisitos e instrucciones de nuestro cliente para que podamos facilitar la provisión de los servicios que
        nuestros clientes hayan solicitado. Si es un cliente
        de Impulse actual o anterior y desea acceder, corregir, enmendar o eliminar sus datos personales, dirija su
      ...
      <p class="text-sm mt-2">Impulse garantizará, en la medida de lo razonablemente posible, que los datos personales
        ...
        procesando datos personales en nombre de un cliente de Impulse (como se describe anteriormente), no podemos
      ...
      <p class="text-sm mt-4">
        ...
        certificado al Departamento de Comercio de los EE. UU. que cumplen con los Principios del Marco de Privacidad de
        Datos UE-EE. UU. (Principios EU-U.S. DPF) con respecto al procesamiento de datos personales recibidos de la
        Unión Europea y el Reino Unido confiando en el EU-U.S. DPF y la Extensión del Reino Unido al EU-U.S. DPF. Si hay
        algún conflicto entre los términos en esta política de privacidad y los Principios EU-U.S. DPF, los Principios
        regirán. Para obtener más información sobre el programa de Marco de Privacidad de Datos (DPF) y ver nuestra
      ...
      <p class="text-sm mt-4">
        ...
        respecto a nuestro manejo de datos personales recibidos confiando en el EU-U.S. DPF y la Extensión del Reino
      ...
      <p class="text-sm mt-4">
        ...
        Internacional de Resolución de Disputas/Asociación Americana de Arbitraje ("AAA-ICDR"), un proveedor de
        resolución de disputas alternativo con sede en los Estados Unidos. Si no recibe un reconocimiento oportuno de su
        queja relacionada con los Principios del DPF de nuestra parte, o si no hemos abordado su queja relacionada con
        los Principios del DPF de manera satisfactoria, visite <a href="https://go.adr.org/dpf_irm.html"
      ...
      <p class="text-sm mt-4">
        ...
        por una decisión de adecuación de la Comisión Europea o la autoridad competente de su país. En la mayoría de los
      ...
      <p class="text-sm mt-4">
        ...
        contractuales tipo de la UE (y su equivalente en el Reino Unido) (las "CCT") cuando sea necesario. Se
      ...
      <p class="text-sm mt-4">
        ...
        proporcionaremos la oportunidad de informarnos si desea optar por no participar en todas las divulgaciones a
        socios comerciales.
      </p>
      ...
      <p class="text-sm mt-4">
        ...
        ejemplo, Impulse está sujeta a los poderes de investigación y ejecución de la Comisión Federal de Comercio
        (FTC). Esto puede incluir la divulgación de su información personal a agencias gubernamentales o de aplicación
        de la ley, o partes privadas, cuando tengamos una creencia de buena fe de que la divulgación es requerida por
        ley o cuando, a nuestra discreción, creemos que la divulgación es necesaria para proteger nuestros derechos
        legales o los de terceros y/o para cumplir con un proceso judicial, orden judicial, reducción de fraude o
        proceso legal que se nos sirva. En tales casos, podemos plantear o renunciar a cualquier objeción legal o
      ...
      <p class="text-sm mt-4">
        ...
        personales se conservan de acuerdo con la política de retención de datos de Impulse y, cuando ya no sean
      ...
      <p class="text-sm mt-4">
        ...
        país, que para Australia es la Oficina del Comisionado Australiano de Información de Privacidad en <a
          href="https://www.oaic.gov.au/">https://www.oaic.gov.au/</a>, o si la queja está relacionada con el GDPR, la
        autoridad supervisora de su país: <a
          href="https://edpb.europa.eu/about-edpb/about-edpb/members_en">https://edpb.europa.eu/about-edpb/about-edpb/members_en</a>,
